	...
	<div id="wrapper" class="container-fluid">
		...
		<main class="col-xs-10 col-xs-offset-1 col-lg-8 col-lg-offset-2">
			...
			C
				...
				<div id="chicken-lettuce3" class="recList nut-free dairy-free" onclick="recipeListModal($(this).attr('id'))"><h5>Chicken Lettuce Wrap</h5></div>
				<div id="chicken-potatoes3" class="recList nut-free dairy-free gluten-free" onclick="recipeListModal($(this).attr('id'))"><h5>Chicken Potato Salad</h5></div>
				<div id="cheese-chicken3" class="recList nut-free" onclick="recipeListModal($(this).attr('id'))"><h5>Chicken Quesadillas</h5></div>
				<div id="chicken-egg2" class="recList nut-free gluten-free" onclick="recipeListModal($(this).attr('id'))"><h5>Chicken Scramble</h5></div>
			...
			E
				...
				<div id="egg-tomatoes1" class="recList nut-free vegetarian gluten-free" onclick="recipeListModal($(this).attr('id'))"><h5>Egg and Tomato Sandwich</h5></div>
